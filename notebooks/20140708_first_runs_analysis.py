...
experiments = OrderedDict([
    ...
    ('E07_ANOPH_workflow_1_9_1',        OrderedDict([('machine', 'KWIAT53'), ('directory', 'E07_ANOPH_workflow_1_9_1'),        ('readsfmt', 'fastq'), ('lastal_a', 2), ('lastal_m', 1), ('ylim_hist', 1000)])),
    ('E07_ANOPH_workflow_1_9_1',        OrderedDict([('machine', 'KWIAT53'), ('directory', 'E07_ANOPH_workflow_1_9_1'),        ('readsfmt', 'fastq'), ('lastal_a', 2), ('lastal_m', 10), ('ylim_hist', 1000)])),
    ('E07_ANOPH_workflow_1_9_1',        OrderedDict([('machine', 'KWIAT53'), ('directory', 'E07_ANOPH_workflow_1_9_1'),        ('readsfmt', 'fastq'), ('lastal_a', 1), ('lastal_m', 1), ('ylim_hist', 1000)])),
    ('E07_ANOPH_workflow_1_9_1',        OrderedDict([('machine', 'KWIAT53'), ('directory', 'E07_ANOPH_workflow_1_9_1'),        ('readsfmt', 'fastq'), ('lastal_a', 3), ('lastal_m', 1), ('ylim_hist', 1000)])),
])
